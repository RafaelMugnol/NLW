    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                ...
                <Image style={styles.pointImage} source={{ uri: 'https://images.unsplash.com/photo-1506972905718-359e73c4c49a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=60' }} />
            ...
            <View style={styles.footer}>
                <RectButton style={styles.button} onPress={handleWhatsApp}>
                    <FontAwesome name='whatsapp' colot='#FFF' size={20} />
                ...
                <RectButton style={styles.button} onPress={handleComposeEmail}>
                    <Icon name='mail' colot='#FFF' size={20} />
                    <Text style={styles.buttonText}>
                        E-mail
                    </Text>
                </RectButton>
